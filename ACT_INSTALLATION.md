...
1. Get your existing OBS overlay url. It's usually something like: `https://goldenchrysus.github.io/ffxiv/ember-overlay-dev/?HOST_PORT=ws://127.0.0.1/ws`
...
4. The URL should now look something like: `https://goldenchrysus.github.io/ffxiv/ember-overlay-dev/?mode=your_mode&HOST_PORT=ws://127.0.0.1/ws`
...
5. The available modes are `stats` (for the normal parsing overlay) and `spells` (for spell timers). Change `your_mode` to one of these options. For example, my final URL's for each mode would be:
    ...
    1. Parsing overlay: `https://goldenchrysus.github.io/ffxiv/ember-overlay-dev/?mode=stats&HOST_PORT=ws://127.0.0.1/ws`

    2. Spell timers: `https://goldenchrysus.github.io/ffxiv/ember-overlay-dev/?mode=spells&HOST_PORT=ws://127.0.0.1/ws`
